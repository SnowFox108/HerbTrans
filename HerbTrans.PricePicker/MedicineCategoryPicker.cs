...
{
    public class MedicineCategoryPicker : ICategoryPicker
    {
        public ProductCategory Category => ProductCategory.Medicine;
        private readonly ILogger _logger;

        public MedicineCategoryPicker(ILogger logger)
        {
            _logger = logger;
        }
